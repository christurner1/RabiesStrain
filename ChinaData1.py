...
plt.figure()
plt.scatter(Time, GuangxiData, marker = 'o', color = 'b', label = 'Number of Infected')
plt.scatter(Time, GuangxiPopData, marker = 'o', color = 'r', label = "Number of Susceptible/Population")
...
results_pop = minimize(residual, params, args = (Time, GuangxiPopData), method = 'Nelder-Mead')
