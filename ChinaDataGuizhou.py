# -*- coding: utf-8 -*-
"""
Created on Thu Nov 18 11:39:25 2021
...
N = np.average(GuizhouPopData * 10000) 

# Initial number of infected and recovered individuals, I0 and R0.
I0, R0 = GuizhouData[0], 0
...
# fit model
results_infected = minimize(residual, params, args = (Time, GuizhouData), method = 'Nelder-Mead') 


# check results of the fit
data_fitted = GuizhouData + results_infected.residual.reshape(GuizhouData.shape)
