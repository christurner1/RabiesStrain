# -*- coding: utf-8 -*-
"""
Created on Thu Nov 18 11:45:52 2021
...
N = np.average(HunanPopData * 10000) 
...
# fit model
results_infected = minimize(residual, params, args = (Time, HunanData), method = 'Nelder-Mead') 
# results_pop = minimize(residual, params, args = (Time, GuangdongData), method = 'Nelder-Mead')

# check results of the fit
data_fitted = HunanData + results_infected.residual.reshape(HunanData.shape)
