# -*- coding: utf-8 -*-
"""
Created on Thu Nov 18 14:52:05 2021
...
N = np.average(JiangxiPopData * 10000) 

# Initial number of infected and recovered individuals, I0 and R0.
I0, R0 = JiangxiData[0], 0
...
# fit model
results_infected = minimize(residual, params, args = (Time, JiangxiData), method = 'Nelder-Mead') 
# results_pop = minimize(residual, params, args = (Time, GuangdongData), method = 'Nelder-Mead')

# check results of the fit
data_fitted = JiangxiData + results_infected.residual.reshape(JiangxiData.shape)
