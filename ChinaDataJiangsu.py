...
N = np.average(JiangsuPopData * 10000) 

# Initial number of infected and recovered individuals, I0 and R0.
I0, R0 = JiangsuData[0], 0
...
# fit model
results_infected = minimize(residual, params, args = (Time, JiangsuData), method = 'Nelder-Mead') 
# results_pop = minimize(residual, params, args = (Time, GuangdongData), method = 'Nelder-Mead')

# check results of the fit
data_fitted = JiangsuData + results_infected.residual.reshape(JiangsuData.shape)
