# -*- coding: utf-8 -*-
"""
Created on Thu Nov 18 11:48:52 2021
...
N = np.average(FujianPopData * 10000) 

# Initial number of infected and recovered individuals, I0 and R0.
I0, R0 = FujianData[0], 0
...
# fit model
results_infected = minimize(residual, params, args = (Time, FujianData), method = 'Nelder-Mead') 
# results_pop = minimize(residual, params, args = (Time, GuangdongData), method = 'Nelder-Mead')

# check results of the fit
data_fitted = FujianData + results_infected.residual.reshape(FujianData.shape)
